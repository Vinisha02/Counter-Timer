...
//converting second, minutes, hour, day in miliseconds 
const second = 1000,
 minute = 60 * second,
 hour = 60 * minute,
 day = 24 * hour ;
...
const timerFunction = () => {
    ...
    let now = new Date(),
        ...
        now = `${mm}/${dd}/${yyyy}`;
    //Taking Tagret Date from User
    const enteredDay = parseInt(prompt("Enter day : ").padStart(2, "0"));
    const enteredMonth = parseInt(prompt("Enter Month : ").padStart(2, "0"));
